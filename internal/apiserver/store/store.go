...
//go:generate mockgen -destination mock_store.go -package store github.com/ashwinyue/maltx/internal/apiserver/store IStore,UserStore,PostStore,ConcretePostStore
